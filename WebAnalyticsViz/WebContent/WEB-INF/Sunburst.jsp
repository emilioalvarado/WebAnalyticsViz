...
<script type="text/javascript" src="resources/js/jquery-ui.min.js"></script>
 ...
 <h4> <span class = "label label-default">Frequency Selector</span></h4>
		 ...
		 Min: <input type="text" name="minVal">  Max: <input type="text" name="maxVal"><button type ="submit">Submit</button></form>
...
<script type="text/javascript" src="resources/js/sequence2.js"></script>
